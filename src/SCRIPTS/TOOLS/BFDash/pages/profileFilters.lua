...
-- finish above the footer at y=232. Slider row (20px) + spacer (6px) + up to
-- 6 field rows * 17px (worst case, D Term Lowpass 1 in dynamic mode) =
-- 128px, span y=86..214. (Same row/spacer sizes as globalFilters.lua for a
-- consistent look between the two Filters tabs.)
