...
testkit.describe("mspMsgs.PID_ADVANCED_FIELDS", function()
    testkit.it("reads throttle/motor fields at their verified offsets, without disturbing neighbors", function()
        ...
        buf = mspBuffer.writeField(buf, mspMsgs.PID_ADVANCED_FIELDS.dMaxGain, 37)
        buf = mspBuffer.writeField(buf, mspMsgs.PID_ADVANCED_FIELDS.dMaxAdvance, 42)
        testkit.assertEquals(mspBuffer.readField(buf, mspMsgs.PID_ADVANCED_FIELDS.dMaxGain), 37, "dMaxGain")
        testkit.assertEquals(mspBuffer.readField(buf, mspMsgs.PID_ADVANCED_FIELDS.dMaxAdvance), 42, "dMaxAdvance")
